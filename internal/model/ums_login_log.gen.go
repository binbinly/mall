...
const TableNameUmsLoginLog = "ums_login_log"

// UmsLoginLog mapped from table <ums_login_log>
...
// TableName UmsLoginLog's table name
func (*UmsLoginLog) TableName() string {
	return TableNameUmsLoginLog
}
