...
func newAdminRolePermission(db *gorm.DB, opts ...gen.DOOption) adminRolePermission {
	...
	_adminRolePermission.RoleID = field.NewInt64(tableName, "role_id")
	_adminRolePermission.PermissionID = field.NewInt64(tableName, "permission_id")
	_adminRolePermission.CreatedAt = field.NewTime(tableName, "created_at")
	_adminRolePermission.UpdatedAt = field.NewTime(tableName, "updated_at")
