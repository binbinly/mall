...
func newAdminMenu(db *gorm.DB, opts ...gen.DOOption) adminMenu {
	...
	_adminMenu.ParentID = field.NewInt64(tableName, "parent_id")
	_adminMenu.Order_ = field.NewInt(tableName, "order")
	_adminMenu.Title = field.NewString(tableName, "title")
	_adminMenu.Icon = field.NewString(tableName, "icon")
	_adminMenu.URI = field.NewString(tableName, "uri")
	_adminMenu.Extension = field.NewString(tableName, "extension")
	_adminMenu.Show = field.NewInt8(tableName, "show")
...
func (a *adminMenu) updateTableName(table string) *adminMenu {
	...
	a.Show = field.NewInt8(table, "show")
