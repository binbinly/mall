...
func newPmsBrand(db *gorm.DB, opts ...gen.DOOption) pmsBrand {
	...
	_pmsBrand.ID = field.NewInt(tableName, "id")
	_pmsBrand.Name = field.NewString(tableName, "name")
	_pmsBrand.Desc = field.NewString(tableName, "desc")
	_pmsBrand.Logo = field.NewString(tableName, "logo")
	_pmsBrand.Cover = field.NewString(tableName, "cover")
	_pmsBrand.IsRelease = field.NewInt8(tableName, "is_release")
	_pmsBrand.Sort = field.NewInt(tableName, "sort")
	_pmsBrand.CreatedAt = field.NewTime(tableName, "created_at")
	_pmsBrand.UpdatedAt = field.NewTime(tableName, "updated_at")
