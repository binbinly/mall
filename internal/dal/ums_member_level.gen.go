...
func newUmsMemberLevel(db *gorm.DB, opts ...gen.DOOption) umsMemberLevel {
	...
	_umsMemberLevel.ID = field.NewInt(tableName, "id")
	_umsMemberLevel.Name = field.NewString(tableName, "name")
	_umsMemberLevel.Growth = field.NewInt64(tableName, "growth")
	_umsMemberLevel.FreeFreight = field.NewInt64(tableName, "free_freight")
	_umsMemberLevel.CommentGrowth = field.NewInt64(tableName, "comment_growth")
	_umsMemberLevel.IsFreight = field.NewInt8(tableName, "is_freight")
	_umsMemberLevel.IsMember = field.NewInt8(tableName, "is_member")
	_umsMemberLevel.IsBirthday = field.NewInt8(tableName, "is_birthday")
	_umsMemberLevel.IsDefault = field.NewInt8(tableName, "is_default")
	_umsMemberLevel.Note = field.NewString(tableName, "note")
	_umsMemberLevel.CreatedAt = field.NewInt(tableName, "created_at")
	_umsMemberLevel.UpdatedAt = field.NewInt(tableName, "updated_at")
...
type umsMemberLevel struct {
	...
	Growth        field.Int64  // 等级需要的成长值
	FreeFreight   field.Int64  // 免运费标准
	CommentGrowth field.Int64  // 评论获取的成长值
	IsFreight     field.Int8   // 是否有免邮特权
	IsMember      field.Int8   // 是否有会员价格特权
	IsBirthday    field.Int8   // 是否有生日特权
...
func (u *umsMemberLevel) updateTableName(table string) *umsMemberLevel {
	...
	u.FreeFreight = field.NewInt64(table, "free_freight")
	u.CommentGrowth = field.NewInt64(table, "comment_growth")
	u.IsFreight = field.NewInt8(table, "is_freight")
	u.IsMember = field.NewInt8(table, "is_member")
	u.IsBirthday = field.NewInt8(table, "is_birthday")
...
func (u *umsMemberLevel) fillFieldMap() {
	...
	u.fieldMap["comment_growth"] = u.CommentGrowth
	u.fieldMap["is_freight"] = u.IsFreight
	u.fieldMap["is_member"] = u.IsMember
