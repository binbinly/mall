...
func newAdminPermission(db *gorm.DB, opts ...gen.DOOption) adminPermission {
	...
	_adminPermission.Slug = field.NewString(tableName, "slug")
	_adminPermission.HTTPMethod = field.NewString(tableName, "http_method")
	_adminPermission.HTTPPath = field.NewString(tableName, "http_path")
	_adminPermission.Order_ = field.NewInt(tableName, "order")
...
func (a *adminPermission) updateTableName(table string) *adminPermission {
	...
	a.HTTPMethod = field.NewString(table, "http_method")
	a.HTTPPath = field.NewString(table, "http_path")
...
func (a *adminPermission) fillFieldMap() {
	...
	a.fieldMap["http_method"] = a.HTTPMethod
	a.fieldMap["http_path"] = a.HTTPPath
