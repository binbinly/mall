...
func newAdminUser(db *gorm.DB, opts ...gen.DOOption) adminUser {
	...
	_adminUser.RememberToken = field.NewString(tableName, "remember_token")
...
func (a *adminUser) updateTableName(table string) *adminUser {
	...
	a.RememberToken = field.NewString(table, "remember_token")
...
func (a *adminUser) fillFieldMap() {
	...
	a.fieldMap["remember_token"] = a.RememberToken
